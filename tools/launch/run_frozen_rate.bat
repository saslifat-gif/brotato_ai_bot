...
set "BROTATO_V4_OUTPUT_DIR=C:\ml\brotato\models\version_3\ranged_smg_v2"
set "BROTATO_V4_UI_BUILD_PROFILE=ranged_smg"
set "BROTATO_V4_UI_DATASET=C:\ml\brotato\models\version_3\ui_decisions_ranged_smg_v2.jsonl"
...
"%PYTHON%" -u -m v4.run_rate --model "%MODEL%" --state-hz %RATE_HZ% --episodes %EPISODES% --results "%RESULTS%" --combat-dataset "%DECISIONS%" --device cpu --torch-threads %BROTATO_TORCH_THREADS% >> "%OUT%" 2>> "%ERR%"
