...
The workflow is:
    ...
    python v4/dagger_corrective.py review ...
    python v4/dagger_corrective.py label ...
    python v4/dagger_corrective.py merge ...
    python v4/dagger_corrective.py evaluate ...
...
# ``python v4/dagger_corrective.py`` sets sys.path[0] to the v4 directory,
# while ``python -m v4.dagger_corrective`` starts at the repository root.
...
def merge_corrective_dataset(base_dataset: Path, corrections: Path, output: Path, *, include_holdout: bool = False) -> dict[str, Any]:
    ...
    from v4.merge_rich_human_demos import merge_sources
